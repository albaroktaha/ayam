                                ...
                                <div class="col-sm-12">
                                    <div class="card-box table-responsive">
                                        <p class="text-muted font-13 m-b-30">
                                            <a href="/product-distributor/create" class="btn btn-sm btn-primary"><i
                                                ...
                                                @if (!empty($distributor_products))
                                                    @forelse($distributor_products as $key => $data)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <img src="/uploads/{{ $data->distributor_product_image }}"
                    ...
                    <span class="badge {{ ($data->status == 'Processing') ? 'badge-warning' :
                      (($data->status == 'Canceled') ? 'badge-danger' :
                        'badge-success') }}">{{$data->status}}
                                                            ...
                                                            <td>
                                                                <a href="/product-distributor/{{ $data->id }}/edit"
                                                            ...
                                                            <td>
                                                                <form method="POST"
                                                                    action="/product-distributor/{{ $data->id }}">
                                                                    @csrf
                                                                    @method('delete')
