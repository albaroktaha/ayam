                                                ...
                                                @if (!empty($order))
                                                    @forelse($order as $key => $data)
                                                        <tr>
                                                            ...
                                                            <td>Rp.
                                                                {{ number_format($data->order_distributor_product_price) }}
                                                            </td>
                                                            <td>
                                                                Rp.
                                                                {{ number_format($data->order_distributor_product_total) }}
                                                            </td>
                                                            <td>{{ $data->username }}</td>
                                                            <td>
                                                                <span
                                                                    class="badge {{ $data->order_distributor_product_status == 'Pending'
                                                                        ? 'badge-warning'
                                                                        : ($data->order_distributor_product_status == 'Canceled'
                                                                            ? 'badge-danger'
                                                            ...
                                                            <td>
                                                                ...
                                                                @else
                                                                    <form action="/orders-distributor/{{ $data->id }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('put')
