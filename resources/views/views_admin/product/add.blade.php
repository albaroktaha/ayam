				...
				<div class="x_panel">
					...
					<div class="x_content">
						<form action="/product" method="POST" enctype="multipart/form-data">
							...
							<div class="field item form-group">
								<label class="col-form-label col-md-3 col-sm-3  label-align">Distributor By<span class="required">*</span></label>
								<div class="col-md-6 col-sm-6">
									<select name="id_distributor" class="form-control">
										<option value="">--Pilih--</option>
										@forelse($distributor as $key => $data)
											<option value="{{$data->id}}">{{$data->distributor_name}}</option>
										@empty
										@endforelse
									</select>
								</div>
