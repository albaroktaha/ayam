                                                ...
                                                <form action="/stock" method="POST">
                                                    ...
                                                    <h2>
                                                        ...
                                                        <input type="hidden" name="product_name"
                                                            value="{{ $data->distributor_product_name }}">
                                                    </h2>
                                                    <h5>
                                                        Rp. {{ number_format($data->distributor_product_price) }}
                                                        <input type="hidden" name="product_harga"
                                                            value="{{ $data->distributor_product_price }}">
                                                    </h5>
                                                    ...
                                                    <ul class="list-unstyled">
                                                        ...
                                                        <li>{{ substr($data->distributor_product_description, 0, 100) }}...
                                                        </li>
                                                    </ul>
                                            </div>
                                            <div class="right col-md-5 col-sm-5 text-center">
                                                <img src="{{ asset('uploads/' . $data->distributor_product_image) }}"
