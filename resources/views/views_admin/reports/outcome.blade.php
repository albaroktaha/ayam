            ...
            <div class="col-sm-12">
                <div class="card-box table-responsive">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            @forelse($getOutcome as $key => $data)
                            <tr>
                                <th scope="row">{{$key + 1}}</th>
                                <td>{{ $data->updated_at }}</td>
                                <td>{{ ucfirst($data->order_distributor_product_distributor) }}</td>
                                <td>{{ $data->order_distributor_product_name_product }}</td>
                                <th>{{ $data->order_distributor_product_quantity }}</th>
                                <th>Rp. {{ number_format($data->order_distributor_product_price) }}</th>
                                <th>Rp. {{ number_format($data->order_distributor_product_total) }}</th>
                            </tr>
                            @empty
